...
TASK_METADATA = [
    ...
    {"task_id": "task2_django_app", "name": "Django multi-regulation audit", "difficulty": "medium", "max_steps": 50, "file_budget": 3},
    {"task_id": "task3_microservices", "name": "Microservices strategic audit", "difficulty": "hard", "max_steps": 50, "file_budget": 1},
]
